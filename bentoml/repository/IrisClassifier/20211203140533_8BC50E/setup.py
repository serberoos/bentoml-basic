...
setuptools.setup(
    name='IrisClassifier',
    version='20211203140533_8BC50E',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - IrisClassifier:20211203140533_8BC50E
...
""",
    ...
    package_data={
        'IrisClassifier': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'IrisClassifier=IrisClassifier:cli',
        ],
    }
)
